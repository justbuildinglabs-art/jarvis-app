// ---------------------------------------------------------------------------
// Rewriting text so a speech engine says it the way a person would.
//
// Phonemizers are bad at notation. Kokoro reads "$4,200" as "dollar 4 200"
// and "$200M" as "dollar 2 M". Spelling the money out in words fixes every
// source at once — router replies, mined headlines, run summaries — instead
// of teaching each of them to format differently.
//
// Spoken numbers also get ROUNDED, which is a judgement rather than a bug
// fix: "four thousand two hundred dollars" is choppy, "four thousand dollars"
// flows. Precision lives on the screen; the voice speaks in wave-tops.
//
// Pure module: no env, no fs, no clock.
// ---------------------------------------------------------------------------
